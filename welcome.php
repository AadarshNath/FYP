...
<head>
    ...
    <title>Welcome | XAM Prepbuddy</title>
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="welcome.php?q=1"><b>XAM Prepbuddy</b></a>
        </div>
        ...
        <button type="button" class="btn btn-danger">Log out</button>&nbsp;</a></li>
</ul>
