...
<head>
    ...
    <title>Dashboard | XAM Prepbuddy</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php?q=1"><b>XAM Prepbuddy</b></a>
                
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    
                    <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dashboard.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home<span class="sr-only">(current)</span></a></li>
                    <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dashboard.php?q=2"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li>
                    <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
                    <li><a href="dashboard.php?q=4"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Add Quiz</a></li>
                    <li><a href="dashboard.php?q=5"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;Remove Quiz</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li <?php echo''; ?> >
                    <a href="index.php"><span class="log-out" aria-hidden="true"></span>
                    <button type="button" class="btn btn-danger">Log out</button>&nbsp;</a></i>
                </ul>
            </div>
        </div>
    </nav>
